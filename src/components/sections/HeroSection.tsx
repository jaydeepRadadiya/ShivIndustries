    ...
    <section id="hero" className="relative h-screen flex items-center justify-center text-center bg-background overflow-hidden pt-16">
      ...
      <div className="relative z-10 p-6 max-w-4xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
          <Button size="lg" className="px-8 py-3 text-lg transition-all duration-300 hover:scale-105">Get Your Custom Packaging Quote</Button>
          <Button size="lg" variant="outline" className="px-8 py-3 text-lg border-secondary text-secondary-foreground hover:bg-secondary hover:text-secondary-foreground transition-all duration-300 hover:scale-105">Explore Our Product Range</Button>
        </div>
      </div>
    </section>
  );
